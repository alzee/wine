 ...
 */
final class Version20221007050245 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_agency DROP FOREIGN KEY FK_B34FD633B092A811');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dealer (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, contact VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, phone VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, address VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, district VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, type SMALLINT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE product_agency (id INT AUTO_INCREMENT NOT NULL, agency_id INT NOT NULL, product_id INT NOT NULL, stock SMALLINT NOT NULL, price INT NOT NULL, INDEX IDX_12BC87424584665A (product_id), INDEX IDX_12BC8742CDEADB2A (agency_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE order_agency (id INT AUTO_INCREMENT NOT NULL, store_id INT NOT NULL, quantity SMALLINT NOT NULL, price INT NOT NULL, date DATETIME NOT NULL, INDEX IDX_B34FD633B092A811 (store_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE order_agency ADD CONSTRAINT FK_B34FD633B092A811 FOREIGN KEY (store_id) REFERENCES store (id)');
