 ...
 */
final class Version20230218065553 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE borrow (id INT AUTO_INCREMENT NOT NULL, salesman_id INT NOT NULL, product_id INT NOT NULL, claim_id INT NOT NULL, qty SMALLINT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_55DBA8B09F7F22E2 (salesman_id), INDEX IDX_55DBA8B04584665A (product_id), UNIQUE INDEX UNIQ_55DBA8B07096A49F (claim_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
