 ...
 */
final class Version20220906143722 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_restaurant ADD CONSTRAINT FK_584FEF6AB1E7706E FOREIGN KEY (restaurant_id) REFERENCES org (id)');
